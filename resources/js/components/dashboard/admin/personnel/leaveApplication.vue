        ...
        <a-table :columns="columns" :data-source="data" :expanded-row-keys="expandedRowKeys"
            ...
            <template #expandedRowRender="{ record }">
                ...
                <div class="border bg-white drop-shadow p-2 space-y-2">
                    ...
                    <p>
                        Date Filed: {{ record.dateFiled }}
                    </p>
                    <p>
                        No. of Days: <span class="text-rose-700">{{ record.noOfDays }}</span>
                    </p>
                    <p>
                        Date of Leave {{ record.dateOfLeave }}
                    </p>
                </div>
            </template>
...
export default defineComponent({
    ...
    methods: {
        async fetchData() {
            ...
            try {
                const response = await axios.get('/api/admin/getLeaveApplications', { headers });
