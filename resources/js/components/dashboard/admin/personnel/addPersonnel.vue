<template>
    <div class="w-full flex justify-center">
        <a-modal v-model:open="open" title="New Personnel" width="1000px" style="top: 20px" :maskClosable="false"
            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="top"
                ...
                <div class="flex w-full space-x-5">
                    ...
                    <div class="w-2/3 rounded bg-gray-100 p-2">
                        ...
                        <FormItem label="Personnel Role" prop="personnelRole" class="p-0  mt-5">
                            <Select v-model="formValidate.personnelRole" style="width:100%"
    ...
    methods: {
        async handleOk(name) {
            ...
            this.$refs[name].validate((valid) => {
                if (valid) {
                    axios.post(`/api/admin/storePersonnel`, this.formValidate, { headers })
